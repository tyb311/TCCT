...
IAA_NOISE = iaa.SomeOf(3, children=[# Noise
...
IAA_BLEND = iaa.SomeOf(3, children=[# Noise
		# Blend
...
TRANS_AUG = alb.Compose([
	...
	# alb.Transpose(p=.5), alb.RandomRotate90(p=.5),
...
class GoalClsSet(paddle.io.Dataset):
	...
	def __getitem__(self, idx):
		...
		if self.mode=='train':
			...
			img = IAA_NOISE(image=img)
			img = IAA_BLEND(image=img)
		else:
